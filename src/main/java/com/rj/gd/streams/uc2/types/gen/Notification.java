...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5220299285418262816L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"com.rj.gd.streams.uc2.types.gen\",\"fields\":[{\"name\":\"InvoiceNumber\",\"type\":[\"null\",\"string\"]},{\"name\":\"CustomerCardNo\",\"type\":[\"null\",\"string\"]},{\"name\":\"TotalAmount\",\"type\":[\"null\",\"float\"]},{\"name\":\"EarnedLoyaltyPoints\",\"type\":[\"null\",\"float\"]}]}");
  ...
  public static Notification fromByteBuffer(
   ...
   private java.lang.Float EarnedLoyaltyPoints;
   ...
   */
  public Notification(java.lang.CharSequence InvoiceNumber, java.lang.CharSequence CustomerCardNo, java.lang.Float TotalAmount, java.lang.Float EarnedLoyaltyPoints) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: EarnedLoyaltyPoints = (java.lang.Float)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.lang.Float getEarnedLoyaltyPoints() {
   ...
   * @param value the value to set.
   */
  public void setEarnedLoyaltyPoints(java.lang.Float value) {
   ...
   */
  public static com.rj.gd.streams.uc2.types.gen.Notification.Builder newBuilder() {
    return new com.rj.gd.streams.uc2.types.gen.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.rj.gd.streams.uc2.types.gen.Notification.Builder newBuilder(com.rj.gd.streams.uc2.types.gen.Notification.Builder other) {
    if (other == null) {
      return new com.rj.gd.streams.uc2.types.gen.Notification.Builder();
    } else {
      return new com.rj.gd.streams.uc2.types.gen.Notification.Builder(other);
    }
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.rj.gd.streams.uc2.types.gen.Notification.Builder newBuilder(com.rj.gd.streams.uc2.types.gen.Notification other) {
    if (other == null) {
      return new com.rj.gd.streams.uc2.types.gen.Notification.Builder();
    } else {
      return new com.rj.gd.streams.uc2.types.gen.Notification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.rj.gd.streams.uc2.types.gen.Notification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.rj.gd.streams.uc2.types.gen.Notification other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder setInvoiceNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder clearInvoiceNumber() {
      InvoiceNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder setCustomerCardNo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder clearCustomerCardNo() {
      CustomerCardNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder setTotalAmount(java.lang.Float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder clearTotalAmount() {
      TotalAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder setEarnedLoyaltyPoints(java.lang.Float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rj.gd.streams.uc2.types.gen.Notification.Builder clearEarnedLoyaltyPoints() {
    ...
    public Notification build() {
      try {
        ...
        record.EarnedLoyaltyPoints = fieldSetFlags()[3] ? this.EarnedLoyaltyPoints : (java.lang.Float) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (this.EarnedLoyaltyPoints == null) {
      ...
      out.writeIndex(1);
      out.writeFloat(this.EarnedLoyaltyPoints);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        this.EarnedLoyaltyPoints = in.readFloat();
      }
